...
def plot_predictions_regression(
    ...
    Y_test: np.ndarray,
    y_pred: np.ndarray,
    pred_std: np.ndarray or None = None,
    pred_quantiles: np.ndarray or None = None,
    epistemic: np.ndarray or None = None,
    aleatoric: np.ndarray or None = None,
    samples: np.ndarray or None = None,
    title: str = None,
